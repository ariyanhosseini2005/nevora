...
const outputDirectory = path.join(
  storyboardRoot,
  "grinder-transition-masters-2k",
);
const manifestPath = path.join(
  outputDirectory,
  "nevora-one-take_f0492-f0539_master-manifest-v001.json",
);
...
const manifest = {
  ...
  active_sources: {
    F492: "v001 approved crease-ownership boundary",
    "F493-F503": "v001 restrained depth-travel production sheet",
    "F504-F515": "v001 burr-reveal production sheet",
    "F516-F527": "v001 contact-loading production sheet",
    "F528-F539": "v001 crease-led fracture production sheet",
    "F540 boundary": "v001 particle-tunnel anchor",
  },
  continuity_audit: {
    report:
    ...
    visual_rules: [
      "Exactly one hero bean remains whole before controlled fracture.",
      "The drum circle becomes graphite burr geometry behind bean occlusion.",
      "Burr approach precedes load; load precedes crease-led separation.",
      "Large fragments retain traceable outer-skin, crease, and tip identity.",
      "No explosion, spark, smoke, duplicate bean, dust wall, or portafilter.",
    ],
  },
  scaling: {
