...
const reviewPath = path.join(
  storyboardRoot,
  "heat-acceptance-review-sequence-v1.jpg",
);
const metricsPath = path.join(
  storyboardRoot,
  "heat-acceptance-continuity-metrics-v1.json",
);

const packs = [
  { start: 396, file: "heat-acceptance-run-01-f396-f407-v1.png" },
  { start: 408, file: "heat-acceptance-run-02-f408-f419-v1.png" },
  { start: 420, file: "heat-acceptance-run-03-f420-f431-v1.png" },
  { start: 432, file: "heat-acceptance-run-04-f432-f443-v1.png" },
];
...
async function buildMetrics(manifest) {
  ...
  const report = {
    ...
    identity_rules: [
      "Exactly one hero seed per active frame.",
      "Color progresses monotonically from pale green to early cinnamon.",
      "Vapor remains sparse, transparent, and physically attached to motion.",
      "No flame, smoke wall, background beans, oil, or char.",
    ],
    metric:
