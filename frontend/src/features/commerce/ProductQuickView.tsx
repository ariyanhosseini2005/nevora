...
export function ProductQuickView({
  ...
  return (
    <AnimatePresence>
      {product && localized && (
        <div className="fixed inset-0 z-[90] grid place-items-end overflow-y-auto p-0 sm:place-items-center sm:p-md">
          <motion.button
            type="button"
            tabIndex={-1}
            aria-hidden="true"
          ...
          >
            ...
            <div className="relative flex flex-col overflow-y-auto p-md [scrollbar-width:none] [&::-webkit-scrollbar]:hidden sm:p-lg lg:p-xl">
              <button
                ref={closeButtonRef}
                type="button"
                className="absolute end-md top-md grid size-11 place-items-center rounded-full border border-coffee-dark/12 bg-soft-white/90 transition-colors hover:border-premium-gold hover:bg-premium-gold/10 focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-premium-gold"
                aria-label={closeLabel}
                onClick={onClose}
              >
              ...
              <div className="pe-xl">
                ...
                <h2
                  ...
                  className="mt-sm max-w-[26rem] font-heading text-3xl leading-tight sm:text-4xl"
                >
                  {localized.name}
                </h2>
              </div>
